...
import { FaWhatsapp, FaEnvelope, FaGavel, FaMapMarkerAlt, FaPhoneAlt, FaPaperPlane, FaShieldAlt } from "react-icons/fa";
...
export default function Contact() {
  ...
  return (
    <div style={styles.container}>
      {/* 🌌 KHATRANAK ANIMATED BACKGROUND GRID */}
      ...
      <style>{`
        ...
        .bg-grid {
          ...
          background-image: linear-gradient(rgba(0, 224, 255, 0.1) 1px, transparent 1px),
        ...
        @media (max-width: 900px) {
          .contact-stack { grid-template-columns: 1fr !important; }
        }
      `}</style>
      ...
      <div style={{ position: 'relative', zIndex: 10 }}>
        ...
        <div className="contact-stack" style={styles.grid}>
          ...
          >
            ...
            <div style={styles.mapBox}>
              <iframe 
                title="map" 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d241317.1160990422!2d72.74109995!3d19.08219785!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c6306644edc1%3A0x5da4ed8f8d648c69!2sMumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1700000000000" 
                style={styles.map} 
          ...
          <motion.div style={styles.card}>
            ...
            <form onSubmit={handleSubmit} style={styles.form}>
              ...
              <motion.button 
                whileHover={{ background: '#00e0ff', color: '#000', boxShadow: '0 0 20px #00e0ff' }}
                style={styles.btn}
                disabled={loading}
              >
        ...
        >
          <div style={styles.lawyerLeft}>
            <div className="float-anim"><FaGavel size={40} color="#00e0ff" /></div>
            <div>
              <h2 style={{ margin: 0, fontSize: '20px' }}>LEGAL & AGREEMENT HELP</h2>
              <p style={{ margin: 0, opacity: 0.7, fontSize: '14px' }}>Get your Rental Agreements & Police Verification done.</p>
            </div>
          </div>
          <motion.a 
            href="https://your-lawyer-link.com" 
            whileHover={{ scale: 1.1 }}
            style={styles.lawyerBtn}
          >
            GO TO LAWYER PORTAL <FaShieldAlt />
          </motion.a>
        </motion.div>
      </div>
